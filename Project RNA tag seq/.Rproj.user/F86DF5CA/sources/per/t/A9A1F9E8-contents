...
## remove all genes with counts < 10 in more than 10% of samples -- here, same as DEseq2 guide
...
ggplot(normcounts.coldata.LH, aes(x=group,y=Npvf, fill=group)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(position = position_jitter(width = .1)) +
  stat_compare_means(method = "t.test") + 
  ggtitle("Npvf")
...
ggplot(normcounts.coldata.LH, aes(x=group,y=Mc3r, fill=group)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(position = position_jitter(width = .1)) +
  stat_compare_means(method = "t.test") + 
  ggtitle("Mc3r")

ggplot(normcounts.coldata.LH, aes(x=Mc3r,y=wt.rate.pct, color=group)) +
  geom_smooth(method="lm") +
  geom_point()

ggplot(normcounts.coldata.LH, aes(x=Mc3r,y=food.eff, color=group)) +
  geom_smooth(method="lm") +
  geom_point()

ggplot(normcounts.coldata.LH, aes(x=Mc3r,y=food.total, color=group)) +
  geom_smooth(method="lm") +
  geom_point()

ggplot(normcounts.coldata.LH, aes(x=Mc3r,y=wt.day.15, color=group)) +
  geom_smooth(method="lm") +
  geom_point()

ggplot(normcounts.coldata.LH, aes(x=Mc3r,y=total.fat, color=group)) +
  geom_smooth(method="lm") +
  geom_point()
...
ggplot(normcounts.coldata.LH, aes(x=group,y=Gpr50, fill=group)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(position = position_jitter(width = .1)) +
  stat_compare_means(method = "t.test") + 
  ggtitle("Gpr50")
...
ggplot(normcounts.coldata.LH, aes(x=group,y=Ntsr2, fill=group)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(position = position_jitter(width = .1)) +
  stat_compare_means(method = "t.test") + 
  ggtitle("Ntsr2")
...
ggplot(normcounts.coldata.LH, aes(x=group,y=Stx1a, fill=group)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(position = position_jitter(width = .1)) +
  stat_compare_means(method = "t.test") + 
  ggtitle("Stx1a")
...
ggplot(normcounts.coldata.LH, aes(x=group,y=Ptgds, fill=group)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(position = position_jitter(width = .1)) +
  stat_compare_means(method = "t.test") + 
  ggtitle("Ptgds")
...
ggplot(normcounts.coldata.LH, aes(x=group,y=Clip2, fill=group)) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(position = position_jitter(width = .1)) +
  stat_compare_means(method = "t.test") + 
  ggtitle("Clip2")
...
#### AND (?) genes in strongest ME GO terms?
